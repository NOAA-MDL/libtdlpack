...
C LIBTDLPACK
      ...
      INTEGER(KIND=C_INT32_T) :: KFILDO
      INTEGER(KIND=C_INT32_T) :: KFILIO
      INTEGER(KIND=C_INT32_T) :: L3264B
      INTEGER(KIND=C_INT32_T) :: L3264W
      INTEGER(KIND=C_INT32_T) :: NTOTBY
      INTEGER(KIND=C_INT32_T) :: NTOTRC
      INTEGER(KIND=C_INT32_T) :: IER
C LIBTDLPACK
      DIMENSION IPACK(6)
      DIMENSION NBYTES(2)
C
